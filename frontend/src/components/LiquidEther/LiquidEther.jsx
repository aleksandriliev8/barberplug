  ...
  useEffect(() => {
    ...
    class CommonClass {
      constructor() {
        ...
        this.pixelRatio = 1; this.fboWidth = null; this.fboHeight = null;
        this.time = 0; this.delta = 0; this.container = null;
        this.renderer = null; this.clock = null;
      }
      init(container) {
    ...
    class ExternalForce extends ShaderPass {
      constructor(simProps) {
        super({ output: simProps.dst }); this.init2(simProps);
      }
      init2(simProps) {
        super.init();
      ...
      update(props) {
        ...
        u.force.value.set(forceX, forceY); u.center.value.set(centerX, centerY); u.scale.value.set(props.cursor_size, props.cursor_size);
        super.update();
      }
    }
